...
export class DataService {
    ...
    public usergroupsAll(sortBy: string, sortDir: number): Observable<IAnswer<Usergroup[]>> | null {return this.sendRequest("POST", "usergroups/all", {sortBy, sortDir}, true);}
    public usergroupsChunk(from: number, q: number, sortBy: string, sortDir: number): Observable<IAnswer<Usergroup[]>> | null {return this.sendRequest("POST", "usergroups/chunk", {from, q, sortBy, sortDir}, true);}
    public usergroupDelete(_id: string): Observable<IAnswer<void>> | null {return this.sendRequest("DELETE", `usergroups/delete/${_id}`, null, true);}
    public usergroupsDeleteBulk(_ids: string[]): Observable<IAnswer<void>> | null {return this.sendRequest("DELETE", "usergroups/deletebulk", _ids, true);}
